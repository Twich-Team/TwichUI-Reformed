### Version 0.0.2-ALPHA [ March 27 2026 ]
...
- Migrated all remaining notification configurations into the central Notifications section
- Moved away from an ElvUI mover to anchor the notification to an in-house mover; added chat frame attachment options
...
- Updated the styling of the Chores tracker frame to be more inline with the current styling; added the ability to configure font and font sizes.
- Updated some styling in best in slot frames to new styling; more to come.
- Updated overview page on configuration.
- Currencies for which you've collected the maximum amount at the time will be highlighted red in the currencies datatext and its tooltip.
