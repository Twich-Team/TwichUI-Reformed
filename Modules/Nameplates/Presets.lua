...
Nameplates.NAMEPLATE_PRESETS = Nameplates.NAMEPLATE_PRESETS or {
    {
        ...
        name = "Standard",
        export =
        [=[TNP1:{aggroColorDps={0.843137,0.262745,0.352941,1},auraFilter="HARMFUL",auraOffsetX=0,auraOffsetY=-20,auraOnlyMine=true,auraSize=26,auraTimerFontSize=18,castBarTexture="TwichUI Bright",castBgColor={0.05,0.06,0.08,0.92},castColor={0.96,0.76,0.24,1},castEmphasisArrowStyle="Arrow44",castEmphasisArrows=true,castEmphasisBorderColor={0,0.909804,0.960784,0.8},castEmphasisEnabled=true,castEmphasisGlowColor={0,0.909804,0.960784,0.8},castEmphasisScale=1.5,castFontOutline="NONE",castFontShadow=true,castFontSize=10,castIconAnchor="LEFT",castIconOffsetY=8,castIconSize=30,clampTargetNameplateToScreen=false,colorBoss={0.611765,0.313726,0.843137,1},colorByCaster=true,colorHostile={0.458824,0.533333,0.741176,1},colorMiniboss={0.611765,0.313726,0.843137,1},colorNpcCaster={0.396078,0.709804,0.741176,1},colorRare={0.454902,0.843137,0.819608,1},enabled=true,friendly={castHeight=6,enabled=true,healthColorMode="class",healthFontShadow=true,healthFormat="none",healthTextAnchor="CENTER",height=15,nameAnchorPoint="ABOVE_CENTER",nameColorClass=false,nameFontOutline="NONE",nameFontSize=16,nameJustify="CENTER",nameOffsetY=0,showAuras=false,showCastBar=false,showLevel=false,showPowerBar=false,width=125},healthBgColor={0.14902,0.168627,0.227451,0.92},healthBgTexture="TwichUI AngledLines",healthColorMode="reaction",healthFontOutline="NONE",healthFontShadow=true,healthFontSize=12,healthFormat="percent",healthTextAnchor="RIGHT",height=26,inactiveAlpha=0.5,nameAnchorPoint="HEALTH_LEFT",nameColorClass=false,nameFont="Exo2 SemiBold",nameFontOutline="NONE",nameFontShadow=true,nameFontSize=13,nameFormat="full",nameOffsetX=0,nameOffsetY=0,nameWidth=135,powerBarGap=0,raidMarkerOffsetY=8,showAbsorb=true,showAuras=true,showCastBar=true,showEliteIcon=false,showLevel=false,showName=true,showPowerBar=true,showRaidMarker=true,showTargetArrows=true,showTargetGlow=true,showThreat=false,stackNameplates=true,stackingHeightScale=1.6,targetArrowSize=26,targetArrowStyle="Arrow9",targetGlowColor={0.937255,0.937255,0.937255,0.898438},targetGlowOutset=3,targetGrowHeight=1.2,targetGrowWidth=1.2,width=180}]=],
    },
}
