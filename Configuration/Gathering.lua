        ...
        args  = {
            ...
            hudGroup          = W.IGroup(10, "Farm HUD Radar", {
                ...
                terrainAlpha = {
                    ...
                    name      = "Terrain Alpha",
                    desc      =
                    "How transparent the minimap terrain is when HUD is active (0 = fully transparent, 1 = fully opaque). Low values will let the ring color show through the minimap center.",
                    order     = 6,
                    min       = 0.0,
                    max       = 1.0,
                    step      = 0.05,
            ...
            datatextGroup     = W.IGroup(40, "Datatext", {
                ...
                gphUpdateInterval = {
                    ...
                    desc     =
                    "How often gold-per-hour is recalculated while a session is active. Loot events still trigger an immediate recalculation.",
                    order    = 5,
                    min      = 1,
                    max      = 30,
                    step     = 1,
