...
local function BuildSmartMountConfiguration()
    ...
    local optionsTab = ConfigurationModule.Widgets.NewConfigurationSection(40, "Smart Mount")
    optionsTab.args = {
...
ConfigurationModule:RegisterConfigurationFunction("Smart Mount", BuildSmartMountConfiguration)
