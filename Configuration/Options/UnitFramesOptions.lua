    ...
    return {
        ...
        args = {
            moduleSettings = Widgets.IGroup(1, "Module", {
                ...
                powerTexture = BuildTextureSelect(8, "Power Bar Texture",
                    "Optional texture override for the power bar only. Falls back to the global bar texture when unset.",
                    { "powerTexture" }, "Use bar texture"),
                smoothBars = BuildToggle(9, "Smooth Bars", "Enable value interpolation for health, power, and castbars.",
                    { "smoothBars" }, db.smoothBars ~= false),
                showHealthText = BuildToggle(10, "Show Health Text", "Show health text tags on frames.",
                    { "showHealthText" }, db.showHealthText ~= false),
                showPowerText = BuildToggle(11, "Show Power Text", "Show power text tags on frames.", { "showPowerText" },
                    db.showPowerText ~= false),
                useClassColor = BuildToggle(12, "Use Class Color",
