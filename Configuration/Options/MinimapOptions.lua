    ...
    return {
        ...
        args = {
                ...
                args = {
                    zone = W.IGroup(10, "Zone", {
                        ...
                        showSubzone = {
                            ...
                            name = "Subzone Detail",
                            desc =
                            "Show the subzone when it differs from the main zone, or instance difficulty when applicable.",
                            handler = Options,
                            get = "GetShowSubzone",
                            set = "SetShowSubzone",
                            disabled = function()
            ...
            coordinatesTab = {
                ...
                order = 30,
                args = {
                    coordinates = W.IGroup(10, "Coordinates", {
                        showCoordinates = {
                            type = "toggle",
                            order = 4,
                            name = "Coordinates",
