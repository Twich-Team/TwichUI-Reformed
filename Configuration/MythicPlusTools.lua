...
local function BuildConfiguration()
    ...
    optionsTab.args = {
        ...
        description = W.Description(1,
            "Curated Mythic+ utility for keystone automation, death notifications, the in-house timer, and the interrupt tracker."),
        general = {
            type = "group",
            name = "General",
            order = 2,
        ...
        deathNotifications = {
            ...
            args = {
                desc = W.Description(1,
                    "Route party deaths into TwichUI notifications with role-based filtering and wipe spam control."),
                enable = {
                    type = "toggle",
                ...
                wipeSpam = {
                    ...
                    desc = "Reduce repeated death toasts during near-full wipes while still tracking the total.",
                    order = 9,
                    width = 1.75,
                    handler = MPTOptions,
        ...
        mythicPlusTimer = {
            ...
            args = {
                ...
                notifications = W.IGroup(15, "Timer Notifications", {
                    desc = W.Description(0,
                        "Send TwichUI notifications when upgrade windows expire or enemy forces reach completion."),
                    plusThree = {
                        type = "toggle",
                        name = "+3 Timer Ends",
                        desc = "Notify when the +3 upgrade window expires.",
                        order = 1,
                        width = 1.5,
                        handler = MPTOptions,
                    ...
                    plusTwo = {
                        type = "toggle",
                        name = "+2 Timer Ends",
                        desc = "Notify when the +2 upgrade window expires.",
                        order = 2,
                        width = 1.5,
                        handler = MPTOptions,
                    ...
                    plusOne = {
                        type = "toggle",
                        name = "+1 Timer Ends",
                        desc = "Notify when the +1 upgrade window expires.",
                        order = 3,
                        width = 1.5,
                        handler = MPTOptions,
                    ...
                    forces = {
                        ...
                        desc = "Notify when enemy forces reach 100%.",
                        order = 4,
                        width = 1.5,
                        handler = MPTOptions,
                    ...
                    displayDuration = {
                        type = "range",
                        name = "Display Duration",
                        desc = "How long timer notifications remain visible.",
                        order = 5,
                        min = 2,
                        max = 30,
                        step = 1,
                    ...
                    sound = {
                        ...
                        dialogControl = "LSM30_Sound",
                        name = "Notification Sound",
                        desc = "Sound to play when a timer notification appears. Set to None to disable.",
                        order = 6,
                        width = 2,
                        values = GetSoundValues,
                        handler = MPTOptions,
