...
local function DisabledWhenFalse(path, options, disabled)
    return function()
        return (type(disabled) == "function" and disabled()) or options:GetValue(path, false) ~= true
    end
end
...
local function BuildGameTab()
    ...
    return {
        ...
        args = {
            ...
            autoSell = FeatureTab(40, "Auto Sell",
                "Build a clear junk-selling profile with paced vendor sales, safety rails, and predictable item rules.",
                {
                    enable = Toggle({ "automation", "autoSellJunk" }, "Enable Auto Sell Junk",
                        "Process junk automatically when a merchant opens.", 2, GameOptions, 1.6, isDisabled),
                    behavior = InlineGroup(10, "Behavior", {
                        summary = Toggle({ "automation", "autoSellShowSummary" }, "Show Sell Summary",
                            "Print the final sale total in chat.", 1, GameOptions, 1.4,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        safeMode = Toggle({ "automation", "autoSellSafeMode" }, "Safe Mode",
                            "Limit each vendor visit to 12 junk slots so large bag clears stay reliable.", 2, GameOptions,
                            1.2,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        throttle = Range({ "automation", "autoSellThrottleMs" }, "Sell Pace (ms)",
                            "Delay between sale attempts. Raise this if a vendor misses items in very large clears.", 3,
                            GameOptions, 50, 400, 10, 1.8,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        behaviorText = Description(4,
                            "The seller starts shortly after the merchant opens and then sells one slot at a time using your latency and sell pace as the throttle."),
                    }),
                    whatToSell = InlineGroup(20, "What To Sell", {
                        qualityText = Description(1,
                            "Quality picks are the base rule. By default only poor-quality items are treated as junk."),
                        poor = Toggle({ "automation", "autoSellIncludeByQuality", "poor" }, "Poor",
                            "Treat poor-quality items as junk.", 2,
                            GameOptions, 0.85,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        common = Toggle({ "automation", "autoSellIncludeByQuality", "common" }, "Common",
                            "Treat common-quality items as junk.", 3, GameOptions, 0.95,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        uncommon = Toggle({ "automation", "autoSellIncludeByQuality", "uncommon" }, "Uncommon",
                            "Treat uncommon-quality items as junk.", 4, GameOptions, 1.0,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        rare = Toggle({ "automation", "autoSellIncludeByQuality", "rare" }, "Rare",
                            "Treat rare-quality items as junk.", 5, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        epic = Toggle({ "automation", "autoSellIncludeByQuality", "epic" }, "Epic",
                            "Treat epic-quality items as junk.", 6, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        ilvlEnable = Toggle({ "automation", "autoSellIncludeBelowItemLevel", "enabled" },
                            "Sell Below Item Level",
                            "Mark equipment below the threshold as junk.", 7, GameOptions, 1.45,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        ilvlValue = Range({ "automation", "autoSellIncludeBelowItemLevel", "value" },
                            "Item Level Threshold",
                            "Equipment below this item level is considered junk when its quality is enabled below.", 8,
                            GameOptions, 0, 700, 1, 1.45,
                            DisabledWhenFalse({ "automation", "autoSellIncludeBelowItemLevel", "enabled" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        ilvlPoor = Toggle({ "automation", "autoSellIncludeBelowItemLevel", "qualities", "poor" }, "Poor",
                            "Apply the item-level rule to poor items.", 9, GameOptions, 0.85,
                            DisabledWhenFalse({ "automation", "autoSellIncludeBelowItemLevel", "enabled" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        ilvlCommon = Toggle({ "automation", "autoSellIncludeBelowItemLevel", "qualities", "common" },
                            "Common",
                            "Apply the item-level rule to common items.", 10, GameOptions, 0.95,
                            DisabledWhenFalse({ "automation", "autoSellIncludeBelowItemLevel", "enabled" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        ilvlUncommon = Toggle({ "automation", "autoSellIncludeBelowItemLevel", "qualities", "uncommon" },
                            "Uncommon",
                            "Apply the item-level rule to uncommon items.", 11, GameOptions, 1.0,
                            DisabledWhenFalse({ "automation", "autoSellIncludeBelowItemLevel", "enabled" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        ilvlRare = Toggle({ "automation", "autoSellIncludeBelowItemLevel", "qualities", "rare" }, "Rare",
                            "Apply the item-level rule to rare items.", 12, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellIncludeBelowItemLevel", "enabled" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        ilvlEpic = Toggle({ "automation", "autoSellIncludeBelowItemLevel", "qualities", "epic" }, "Epic",
                            "Apply the item-level rule to epic items.", 13, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellIncludeBelowItemLevel", "enabled" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unsuitable = Toggle({ "automation", "autoSellIncludeUnsuitableEquipment" },
                            "Sell Unsuitable Equipment",
                            "Mark armor and weapons your class cannot use as junk.", 14, GameOptions, 1.55,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        unsuitablePoor = Toggle({ "automation", "autoSellIncludeUnsuitableEquipmentQualities", "poor" },
                            "Poor",
                            "Apply the unsuitable-equipment rule to poor items.", 15, GameOptions, 0.85,
                            DisabledWhenFalse({ "automation", "autoSellIncludeUnsuitableEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unsuitableCommon = Toggle(
                            { "automation", "autoSellIncludeUnsuitableEquipmentQualities", "common" }, "Common",
                            "Apply the unsuitable-equipment rule to common items.", 16, GameOptions, 0.95,
                            DisabledWhenFalse({ "automation", "autoSellIncludeUnsuitableEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unsuitableUncommon = Toggle(
                            { "automation", "autoSellIncludeUnsuitableEquipmentQualities", "uncommon" }, "Uncommon",
                            "Apply the unsuitable-equipment rule to uncommon items.", 17, GameOptions, 1.0,
                            DisabledWhenFalse({ "automation", "autoSellIncludeUnsuitableEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unsuitableRare = Toggle({ "automation", "autoSellIncludeUnsuitableEquipmentQualities", "rare" },
                            "Rare",
                            "Apply the unsuitable-equipment rule to rare items.", 18, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellIncludeUnsuitableEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unsuitableEpic = Toggle({ "automation", "autoSellIncludeUnsuitableEquipmentQualities", "epic" },
                            "Epic",
                            "Apply the unsuitable-equipment rule to epic items.", 19, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellIncludeUnsuitableEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        relics = Toggle({ "automation", "autoSellIncludeArtifactRelics" }, "Sell Artifact Relics",
                            "Treat artifact relics as junk when found in old content bags.", 20, GameOptions, 1.35,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                    }),
                    protections = InlineGroup(30, "Protect Items", {
                        protectionText = Description(1,
                            "Protection rules run before junk rules. If an item matches one of these, it is kept."),
                        equipmentSets = Toggle({ "automation", "autoSellExcludeEquipmentSets" },
                            "Keep Equipment Set Items",
                            "Never sell items referenced by any saved equipment set.", 2, GameOptions, 1.6,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        unbound = Toggle({ "automation", "autoSellExcludeUnboundEquipment" }, "Keep Unbound Equipment",
                            "Protect unbound armor and weapons for the selected qualities.", 3, GameOptions, 1.5,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        unboundPoor = Toggle({ "automation", "autoSellExcludeUnboundEquipmentQualities", "poor" }, "Poor",
                            "Protect poor unbound equipment.", 4, GameOptions, 0.85,
                            DisabledWhenFalse({ "automation", "autoSellExcludeUnboundEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unboundCommon = Toggle({ "automation", "autoSellExcludeUnboundEquipmentQualities", "common" },
                            "Common",
                            "Protect common unbound equipment.", 5, GameOptions, 0.95,
                            DisabledWhenFalse({ "automation", "autoSellExcludeUnboundEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unboundUncommon = Toggle(
                            { "automation", "autoSellExcludeUnboundEquipmentQualities", "uncommon" }, "Uncommon",
                            "Protect uncommon unbound equipment.", 6, GameOptions, 1.0,
                            DisabledWhenFalse({ "automation", "autoSellExcludeUnboundEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unboundRare = Toggle({ "automation", "autoSellExcludeUnboundEquipmentQualities", "rare" }, "Rare",
                            "Protect rare unbound equipment.", 7, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellExcludeUnboundEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        unboundEpic = Toggle({ "automation", "autoSellExcludeUnboundEquipmentQualities", "epic" }, "Epic",
                            "Protect epic unbound equipment.", 8, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellExcludeUnboundEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        warband = Toggle({ "automation", "autoSellExcludeWarbandEquipment" }, "Keep Warband Equipment",
                            "Protect equipment that can be deposited into the warband bank for the selected qualities.",
                            9,
                            GameOptions, 1.6,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        warbandPoor = Toggle({ "automation", "autoSellExcludeWarbandEquipmentQualities", "poor" }, "Poor",
                            "Protect poor warband-eligible equipment.", 10, GameOptions, 0.85,
                            DisabledWhenFalse({ "automation", "autoSellExcludeWarbandEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        warbandCommon = Toggle({ "automation", "autoSellExcludeWarbandEquipmentQualities", "common" },
                            "Common",
                            "Protect common warband-eligible equipment.", 11, GameOptions, 0.95,
                            DisabledWhenFalse({ "automation", "autoSellExcludeWarbandEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        warbandUncommon = Toggle(
                            { "automation", "autoSellExcludeWarbandEquipmentQualities", "uncommon" }, "Uncommon",
                            "Protect uncommon warband-eligible equipment.", 12, GameOptions, 1.0,
                            DisabledWhenFalse({ "automation", "autoSellExcludeWarbandEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        warbandRare = Toggle({ "automation", "autoSellExcludeWarbandEquipmentQualities", "rare" }, "Rare",
                            "Protect rare warband-eligible equipment.", 13, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellExcludeWarbandEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                        warbandEpic = Toggle({ "automation", "autoSellExcludeWarbandEquipmentQualities", "epic" }, "Epic",
                            "Protect epic warband-eligible equipment.", 14, GameOptions, 0.8,
                            DisabledWhenFalse({ "automation", "autoSellExcludeWarbandEquipment" }, GameOptions,
                                DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled))),
                    }),
                    lists = InlineGroup(40, "Lists", {
                        listText = Description(1,
                            "Use item IDs for exact overrides. Exclusions always win over inclusions."),
                        include = Input({ "automation", "autoSellIncludeList" }, "Always Sell Item IDs",
                            "Comma-separated item IDs that should always be treated as junk unless they are excluded below.",
                            2,
                            GameOptions, 2.0,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                        exclude = Input({ "automation", "autoSellExcludeList" }, "Never Sell Item IDs",
                            "Comma-separated item IDs that should never be sold automatically.", 3, GameOptions, 2.0,
                            DisabledWhenFalse({ "automation", "autoSellJunk" }, GameOptions, isDisabled)),
                    }),
                }),
