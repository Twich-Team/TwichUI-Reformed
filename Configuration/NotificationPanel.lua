            ...
            args = {
                ...
                groupFinder = ConfigurationModule.Widgets.IGroup(25, "Group Finder", {
                    ...
                    testGroupFinderManaforgeNotification = {
                        ...
                        desc = "Send a Manaforge Omega Group Finder notification so you can verify the teleport button behavior.",
                        order = 5,
                        disabled = function() return not Options:GetEnableGroupFinderNotifications() end,
                        handler = Options,
                ...
                ,
                prey = ConfigurationModule.Widgets.IGroup(27, "Prey", {
                    enablePreyNotifications = {
                        type = "toggle",
                        name = "Enable",
                        desc = "Show notifications when a prey hunt becomes active and ready to hunt.",
                        order = 1,
                        handler = Options,
                    ...
                    preyDisplayDuration = {
                        type = "range",
                        name = "Display Duration",
                        desc = "How long prey notifications remain visible before dismissing automatically.",
                        order = 2,
                        min = 2,
                        max = 30,
                        step = 1,
                    ...
                    preySound = {
                        ...
                        dialogControl = "LSM30_Sound",
                        name = "Notification Sound",
                        desc = "Sound to play when a prey hunt becomes ready.",
                        order = 3,
                        width = 2,
                        values = function() return LibStub("LibSharedMedia-3.0"):HashTable("sound") or {} end,
                        disabled = function() return not Options:GetEnablePreyNotifications() end,
