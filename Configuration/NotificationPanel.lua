            ...
            args = {
                ...
                panelLayout = W.IGroup(10, "Panel Layout", {
                    ...
                    anchorY = {
                        ...
                        name = "Position Y",
                        desc =
                        "Vertical offset of the notification anchor from the center of the screen. Positive moves up.",
                        order = 4,
                        softMin = -600,
                        softMax = 600,
                        step = 1,
            ...
            args = {
                ...
                checkpointGroup = W.IGroup(40, "Checkpoint Alerts", {
                    ...
                    enable = {
                        ...
                        width = 1.5,
                        handler = MPTOptions,
                        get = "GetMythicPlusTimerNotifyCheckpointComplete",
                        set = "SetMythicPlusTimerNotifyCheckpointComplete",
                    },
                    displayDuration = {
                        type = "range",
                        name = "Duration",
                        ...
                        step = 1,
                        width = 1.5,
                        disabled = function() return not MPTOptions:GetMythicPlusTimerNotifyCheckpointComplete() end,
                        handler = MPTOptions,
                        get = "GetMythicPlusCheckpointNotificationDisplayTime",
                        set = "SetMythicPlusCheckpointNotificationDisplayTime",
                    },
                    sound = {
                        type = "select",
                        dialogControl = "LSM30_Sound",
                        ...
                        disabled = function() return not MPTOptions:GetMythicPlusTimerNotifyCheckpointComplete() end,
                        handler = MPTOptions,
                        get = "GetMythicPlusCheckpointNotificationSound",
                        set = "SetMythicPlusCheckpointNotificationSound",
                    },
                    test = {
                        type = "execute",
                        name = "Test Notification",
                        ...
                        disabled = function() return not MPTOptions:GetMythicPlusTimerNotifyCheckpointComplete() end,
                        handler = MPTOptions,
                        func = "TestMythicPlusCheckpointNotification",
                    },
                }),
            },
        },
